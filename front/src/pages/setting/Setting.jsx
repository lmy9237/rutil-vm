...
const Setting = ({}) => {
  ...
  const handleTabClick = (tab) => {
    console.log("Setting > handleTabClick ...");
    setActiveTab(tab);
    navigate(tab !== "user" ? `/settings/${tab}` : "/settings");
  };

  useEffect(() => {
    setActiveTab(!section ? "user" : section);
  }, [section]);
                  ...
                  >
                    <div className="setting_system_new_popup">
                      ...
                      <div className="power_table">
                        <Table
                          columns={TableColumnsInfo.SETTING_POPUP_USER}
                          data={userData}
                        />
                      </div>

                      <div
                        className="power_last_content"
