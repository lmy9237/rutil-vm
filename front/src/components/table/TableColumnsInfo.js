...
const TableColumnsInfo = {
  ...
  NETWORK_FROM_CLUSTER: [
    ...
    { accessor: 'status',        clickable: false, header: Localization.kr.STATUS,  width: DEFAULT_WIDTH_ICON_COLUMN },
  ...
  NETWORK_ADAPTER_FROM_HOST: [
    ...
    { accessor: 'rxSpeed',       header: Localization.kr.SPEED_RX }, // Rx 속도
    { accessor: 'txSpeed',       header: Localization.kr.SPEED_TX }, // Tx 속도
    { accessor: 'autoNegotiation', header: "구성된 속도", width: DEFAULT_WIDTH_ICON_COLUMN }, // autoNegotiation
  ...
  DEVICE_FROM_HOST: [
    { accessor: 'name',          header: Localization.kr.NAME,           clickable: false,               },
    { accessor: 'capability',    header: Localization.kr.CAPABILITIES,   clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    ...
    { accessor: 'driver',        header: '드라이버',                      clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
  ],
  IMPORT_NETWORKS: [
    { accessor: "icon",     clickable: false,   header: Localization.kr.STATUS /* width: DEFAULT_WIDTH_ICON_COLUMN */, },
  ...
  NICS2_FROM_VM: [
    { accessor: '_linked',             header: '링크상태',                 clickable: false, width: '4%' },
    { accessor: '_plugged',            header: '연결상태',                 clickable: false, width: '4%' },
    ...
    { accessor: 'interface_',         header: Localization.kr.TYPE,   clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'speed',              header: Localization.kr.SPEED,  clickable: false },
  ],
  NICS_CALC_FROM_VM: [
  ...
  DISKS_FROM_VM: [
    ...
    { accessor: 'virtualSize',    header: Localization.kr.SIZE_VIRTUAL,   clickable: false, width: '7%'},
    ...
    { accessor: 'interface',      header: '인터페이스',                     clickable: false, width: '7%' },
    { accessor: 'logicalName',    header: '논리적 이름',                    clickable: false },
    { accessor: '_status',        header: Localization.kr.STATUS,         clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN  },
    { accessor: 'storageType',    header: `${Localization.kr.STORAGE} ${Localization.kr.TYPE}`, width: '7%',                  clickable: false },
  ...
  DISK_IMAGES_FROM_VM: [
    ...
    { accessor: 'logicalName',    header: '논리적 이름',                  clickable: false },
    { accessor: '_status',        header: Localization.kr.STATUS,       clickable: false },
    { accessor: 'description',    header: Localization.kr.DESCRIPTION,  clickable: false },
  ],
  DISK_LUN_FROM_VM: [
    { accessor: 'icon',           header: '',                           clickable: false, width: '4%' },
  ...
  NETWORKS: [
    ...
    { accessor: 'mtu',           header: 'MTU',                       clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN }
    ],
  VNIC_PROFILES_FROM_NETWORK: [
    ...
    { accessor: 'portMirroring',  header: '포트 미러링',                    clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'passThrough',    header: '통과',                          clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'description',    header: Localization.kr.DESCRIPTION,    clickable: false },
  ],
  ...
  VMS_UP_FROM_NETWORK: [
    { accessor: "icon",         header: Localization.kr.STATUS,        clickable: false , width: '7%' },
    { accessor: '_name',        header: Localization.kr.NAME,          clickable: false },
    // { accessor: 'cluster',   header: Localization.kr.CLUSTER, clickable: false },
    { accessor: 'ipAddress',    header: Localization.kr.IP_ADDRESS,    clickable: false },
    { accessor: 'fqdn',         header: 'FQDN',                        clickable: false },
  ...
  TEMPLATES_FROM_NETWORK: [
    ...
    { accessor: 'status',       header: Localization.kr.STATUS,   clickable: false, width: '7%' },
  ...
  STORAGE_DOMAINS: [
    ...
    { accessor: 'format',         header: '포맷', width: DEFAULT_WIDTH_ICON_COLUMN , align: "center" },
    { accessor: '_status',        header: '데이터 센터간 상태',                width: 100   },
    { accessor: 'availableSizeToGB',  header: Localization.kr.SIZE_AVAILABLE,   width: 70 },
    { accessor: 'usedSizeToGB',       header: Localization.kr.SIZE_USED,        width: 70     },
    { accessor: 'sizeToGB',           header: Localization.kr.SIZE_TOTAL,       width: 70     },
  ...
  FIBRE: [
    { accessor: 'able',             header: 'able',             clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'check',            header: 'check',            clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'status',           header: 'status',           clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'id',               header: 'Lun ID',           clickable: false },
    { accessor: 'size',             header: 'size',             clickable: false },
    { accessor: 'paths',            header: '#path',            clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN},
    { accessor: 'vendorId',         header: 'vendor ID',        clickable: false },
    // { accessor: 'productId', header: 'product ID', clickable: false },
    { accessor: 'serial',           header: 'serial',           clickable: false },
  ...
  DISKS_FROM_STORAGE_DOMAIN: [
    ...
    { accessor: '_bootable',        header: Localization.kr.IS_BOOTABLE,   clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: '_sharable',        header: Localization.kr.IS_SHARABLE,   clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'virtualSizeToGB',  header: Localization.kr.SIZE_VIRTUAL,  clickable: false },
    { accessor: 'actualSizeToGB',   header: Localization.kr.SIZE_ACTUAL,   clickable: false },
    { accessor: 'sparse',           header: Localization.kr.SPARSE,        clickable: false },
    // { accessor: 'storageDomain', header: Localization.kr.DOMAIN, clickable: false },
    // { accessor: 'creationDate', header: Localization.kr.DATE_CREATED, clickable: false },
    ...
    { accessor: '_status',          header: Localization.kr.STATUS,        clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'storageType',      header: Localization.kr.TYPE,          clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'description',      header: Localization.kr.DESCRIPTION,   clickable: false },
  ...
  VMS_IMPORT_NAMES: [
    { accessor: 'name',     header: Localization.kr.NAME,        clickable: false },
    { accessor: 'memory',   header: Localization.kr.MEMORY,      clickable: false , width: 70},
    { accessor: 'cpu',      header: Localization.kr.CPU,         clickable: false ,width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'cpuArc',   header: Localization.kr.ARCH,        clickable: false },
    { accessor: 'diskCnt',  header: `${Localization.kr.DISK} ${Localization.kr.COUNT}`, clickable: false ,width: DEFAULT_WIDTH_ICON_COLUMN},
    { accessor: 'mac',      header: '불량 MAC 재배치',             clickable: false },
    { accessor: 'allow',    header: '부분 허용',                  clickable: false, width: 70  },
    { accessor: 'cluster',  header: Localization.kr.CLUSTER,     clickable: false , width: 280 },
  ],
...
GET_IMPORT_VMS: [
  ...
  DISKS: [
    ...
    { accessor: '_bootable',    header: Localization.kr.IS_BOOTABLE,   clickable: false, align: "left" },
    { accessor: '_sharable',    header: Localization.kr.IS_SHARABLE,   clickable: false, align: "left" },
    { accessor: 'connect',      header: `${Localization.kr.CONNECTION} ${Localization.kr.TARGET}`, clickable: false, align: "left" },
    { accessor: 'storageDomain',header: Localization.kr.DOMAIN,        clickable: false },
    { accessor: 'virtualSizeToGB',  header: Localization.kr.SIZE_VIRTUAL,  clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: '_status',      header: Localization.kr.STATUS,        clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN},
    { accessor: 'storageType',  header: Localization.kr.TYPE,          clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'description',  header: Localization.kr.DESCRIPTION,   clickable: false },
    { accessor: 'dateCreated',  header: Localization.kr.DATE_CREATED,  clickable: false },
  ...
  CLUSTERS_POPUP: [
    { accessor: 'name',             header: Localization.kr.NAME,                clickable: false },
    { accessor: 'allAssigned',      header: '모두 할당',                           clickable: false, width: 80 },
    { accessor: 'allRequired',      header: '모두 필요',                           clickable: false, width: 80 },
    { accessor: 'vmNetMgmt',        header: `${Localization.kr.VM} 네트워크 관리`,  clickable: false, width: 130 },
    { accessor: 'networkOutput',    header: '네트워크 출력',                        clickable: false },
    { accessor: 'migrationNetwork', header: `${Localization.kr.MIGRATION} ${Localization.kr.NETWORK}`, clickable: false, width:130 },
    { accessor: 'glusterNetwork',   header: 'Gluster 네트워크',                    clickable: false },
    { accessor: 'defaultRouting',   header: '기본 라우팅',                          clickable: false },
  ],
  HOSTS_DISCONNECTION: [
