...
const DEFAULT_WIDTH_ICON_COLUMN = "32px";
/**
...
const TableColumnsInfo = {
  ...
  STORAGES_FROM_DATACENTER: [
    ...
    { accessor: '_name',         header: '도메인 이름',                              clickable: true },
  ...
  CLUSTERS: [
    ...
    { accessor: 'description',   header: Localization.kr.DESCRIPTION, clickable: false, },
    { accessor: 'cpuType',       header: `${Localization.kr.CLUSTER} ${Localization.kr.CPU} 유형`, clickable: false, },
    { accessor: 'hostCnt',       header: `${Localization.kr.HOST} 수`, clickable: false, width: '8%' },
    { accessor: 'vmCnt',         header: `${Localization.kr.VM} 수`,   clickable: false, width: '9%'  },
    { accessor: 'comment',       header: Localization.kr.COMMENT, clickable: false, },
  ],
  ...
  VMS_FROM_HOST: [
    ...
    { accessor: '',              header: Localization.kr.SNAPSHOT ,   clickable: false,  },
    { accessor: 'memoryUsage',   header: Localization.kr.MEMORY ,     clickable: false,  },
    { accessor: 'cpuUsage',      header: Localization.kr.CPU ,        clickable: false,  },
    { accessor: 'networkUsage',  header: Localization.kr.NETWORK ,    clickable: false,  },
    { accessor: 'upTime',        header: Localization.kr.UP_TIME ,    clickable: false,  },
  ...
  DEVICE_FROM_HOST: [
    { accessor: 'name',        clickable: false,    header: Localization.kr.NAME },
    { accessor: 'capability',  clickable: false,    header: '기능' },
  ...
  NETWORKS: [
    ...
    { accessor: 'description',   header: Localization.kr.DESCRIPTION, clickable: false, width: '20%' },
  ...
  STORAGE_DOMAINS: [
    { accessor: "icon",           header: Localization.kr.STATUS,       width: DEFAULT_WIDTH_ICON_COLUMN },
    { accessor: 'hostedEngine',   header: Localization.kr.ENGINE,       width: '3%' },
    { accessor: '_name',          header: '도메인 이름',                width: '10%' },
    { accessor: 'domainType',     header: '도메인 유형' },
    { accessor: 'storageType',    header: '스토리지 유형',              width: '10%' },
    { accessor: 'format',         header: '포맷' },
    { accessor: '_status',        header: '데이터 센터간 상태',         width: '10%' },
    { accessor: 'availableSize',  header: Localization.kr.SIZE_AVAILABLE },
    { accessor: 'usedSize',       header: Localization.kr.SIZE_USED },
    { accessor: 'size',           header: Localization.kr.SIZE_TOTAL },
    { accessor: 'description',    header: Localization.kr.DESCRIPTION },
    { accessor: 'comment',        header: Localization.kr.COMMENT,      width: '12%' },
  ],
  ...
  GET_VMS_TEMPLATES: [
    ...
    { accessor: 'disk',        header: '디스크',                   clickable: false },
    { accessor: 'creationTime',header: '생성 일자',                 clickable: false },
  ],
