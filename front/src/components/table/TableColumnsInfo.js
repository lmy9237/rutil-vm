...
const TableColumnsInfo = {
  DATACENTERS: [
    ...
    { accessor: 'hostCnt',       clickable: false,  header: `${Localization.kr.HOST} 수`, width: '7%', align: "center"}, 
    { accessor: 'clusterCnt',    clickable: false,  header: `${Localization.kr.CLUSTER} 수`, width: '7%' , align: "center" }, 
    { accessor: 'version',       clickable: false,  header: '호환 버전', width: '7%', align: "center" },
  ...
  STORAGES_FROM_DATACENTER: [
    ...
    { accessor: '_name',         clickable: true,   header: '도메인 이름', },
    { accessor: 'domainType',    clickable: false,  header: '도메인 유형', },
  ...
  CLUSTERS: [
    ...
    { accessor: 'hostCnt',      clickable: false,   header: `${Localization.kr.HOST} 수`, width: '8%' },
    { accessor: 'vmCnt',        clickable: false,   header: `${Localization.kr.VM} 수`,   width: '9%'  },
    { accessor: 'comment',      clickable: false,   header: Localization.kr.COMMENT },
  ],
  ...
  DISK_IMAGES_FROM_VM: [
    { header: Localization.kr.STATUS, accessor: "icon", clickable: false,width:'4%' },
    { header: Localization.kr.ALIAS, accessor: '_alias', clickable: true ,width:'10%'},
    { header: Localization.kr.IS_BOOTABLE, accessor: 'bootable', clickable: false,width:'4%' },
    { header: Localization.kr.IS_SHARABLE, accessor: 'sharable', clickable: false,width:'4%' },
    { header: Localization.kr.IS_READ_ONLY, accessor: 'readOnly', clickable: false,width:'4%' },
  ...
  SNAPSHOT_INFO_FROM_VM: [
    ...
    { header: '메모리 여부', accessor: 'persistMemory', clickable: false },
  ...
  STORAGE_DOMAINS: [
    ...
    { header: Localization.kr.ENGINE, accessor: 'hostedEngine', width: '3%' },
    ...
    { header: Localization.kr.SIZE_TOTAL, accessor: 'size' },
  ...
  IMPORT_ISCSI: [
    { accessor: 'target',   clickable: true, header: 'IQN' },
    { accessor: 'address',  clickable: true, header: 'address' },
    { accessor: 'port',     clickable: true, header: 'port' },
  ],
  FIBRE: [
  ...
  IMPORT_FIBRE: [
    ...
    { header: '스토리지 Id', accessor: 'id', clickable: true },
  ],
  ...
  VMS_IMPORT_NAMES: [
    ...
    { header: '아키텍처', accessor: 'cpuArc', clickable: false },
    { header: Localization.kr.DISK +" 수", accessor: 'diskCnt', clickable: false },
  ...
  VIRTUAL_DISK:  [
    { header: "선택", accessor: 'check', clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN  },
    ...
    { header: Localization.kr.IS_SHARABLE, accessor: 'sharable', clickable: false, width: '5%'  },
  ],
  // ---------------------------------------------------------------
  ...
  CLUSTER_VM:[
    ...
    { accessor: 'status',  clickable: false,  header: Localization.kr.STATUS, },
    { accessor: 'upTime',  clickable: false,  header: Localization.kr.UP_TIME, },
    { accessor: "cpu",     clickable: false,  header: Localization.kr.CPU, },
    { accessor: 'memory',  clickable: false,  header: Localization.kr.MEMORY, },
    { accessor: 'network', clickable: false,  header: Localization.kr.NETWORK, },
    { accessor: 'ipv4',    clickable: false,  header: Localization.kr.IP_ADDRESS, },
  ],
  CLUSTERS_POPUP: [
    { header: Localization.kr.NAME, accessor: 'name', clickable: false },
