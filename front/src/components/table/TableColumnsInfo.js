...
const TableColumnsInfo = {
  DATACENTERS: [
    ...
    { accessor: 'hostCnt',       header: `${Localization.kr.HOST} ${Localization.kr.COUNT}`,    clickable: false,  width: '7%' ,align: "center" },
    { accessor: 'clusterCnt',    header: `${Localization.kr.CLUSTER} ${Localization.kr.COUNT}`, clickable: false,  width: '7%' , align: "center"  },
    { accessor: 'version',       header: Localization.kr.VERSION_COMPATIBLE,                    clickable: false, width: '7%' , align: "center"  },
  ...
  CLUSTERS_FROM_DATACENTER: [
    ...
    { accessor: 'version',       header: Localization.kr.VERSION_COMPATIBLE, clickable: false, width: 50 },
    { accessor: 'description',   header: Localization.kr.DESCRIPTION ,       clickable: false, width: 500 },
  ],
  STORAGES_FROM_DATACENTER: [
    { accessor: 'status',        header: Localization.kr.STATUS,                               clickable: false },
    { accessor: 'hostedEngine',  header: Localization.kr.ENGINE,                               clickable: false },
    { accessor: '_name',         header: `${Localization.kr.DOMAIN} ${Localization.kr.NAME}`,  clickable: true },
    { accessor: 'domainType',    header: `${Localization.kr.DOMAIN} ${Localization.kr.TYPE}`,  clickable: false },
    { accessor: 'availableSize', header: `${Localization.kr.SIZE_AVAILABLE} (GiB)`,            clickable: false },
    { accessor: 'usedSize',      header: `${Localization.kr.SIZE_USED} (GiB)`,                 clickable: false },
    { accessor: 'diskSize',      header: `${Localization.kr.SIZE_TOTAL} (GiB)`,                clickable: false },
    { accessor: 'description',   header: Localization.kr.DESCRIPTION,                          clickable: false },
  ],
  NETWORK_FROM_DATACENTER: [
    { accessor: '_name',         header: Localization.kr.NAME,        clickable: true, width: '14%',},
    { accessor: 'description',   header: Localization.kr.DESCRIPTION, clickable: false},
  ],
  CLUSTERS: [
    { accessor: '_name',         header: Localization.kr.NAME,                                                        clickable: true,  width: '13%' },
    { accessor: 'description',   header: Localization.kr.DESCRIPTION,                                                 clickable: false, },
    { accessor: 'cpuType',       header: `${Localization.kr.CLUSTER} ${Localization.kr.CPU} ${Localization.kr.TYPE}`, clickable: false, },
    { accessor: 'hostCnt',       header: `${Localization.kr.HOST} ${Localization.kr.COUNT}`,                          clickable: false, width: '8%' },
    { accessor: 'vmCnt',         header: `${Localization.kr.VM} ${Localization.kr.COUNT}`,                            clickable: false, width: '9%'  },
    { accessor: 'comment',       header: Localization.kr.COMMENT, clickable: false, },
  ],
  NETWORK_FROM_CLUSTER: [
    { accessor: '_name',         header: Localization.kr.NAME,                                 clickable: true, width: '18%' },
    { accessor: 'status',        header: Localization.kr.STATUS,                               clickable: false, width: '15%' },
    { accessor: 'role',          header: Localization.kr.ROLE,                                 clickable: false },
    { accessor: 'description',   header: Localization.kr.DESCRIPTION,                          clickable: false },
  ],
  HOSTS: [
  ...
  NETWORK_FROM_HOST_SLAVE:[
    { accessor: 'name', clickable: false, header: Localization.kr.NAME, },
    { accessor: 'macAddress',             header: 'MAC' }, // MAC 주소
  ...
  DEVICE_FROM_HOST: [
    { accessor: 'name',        clickable: false,    header: Localization.kr.NAME },
    { accessor: 'capability',  clickable: false,    header: Localization.kr.CAPABILITIES },
    { accessor: 'vendorName',  clickable: false,    header: '벤더' },
    { accessor: 'productName', clickable: false,    header: '제품' },
    { accessor: 'driver',      clickable: false,    header: '드라이버' },
  ],
  IMPORT_NETWORKS: [
  ...
  DISK_LUN_FROM_VM: [
    ...
    { accessor: 'venderId',       header: '벤더 ID',                     clickable: false },
    { accessor: 'productId',      header: '제품 ID',                     clickable: false },
    { accessor: 'connectionvm',   header: `${Localization.kr.CONNECTION} ${Localization.kr.TARGET}`, clickable: false },
    { accessor: 'interface',      header: '인터페이스',                   clickable: false },
    { accessor: 'logicalName',    header: '논리적 이름',                  clickable: false },
    { accessor: 'description',    header: Localization.kr.DESCRIPTION,  clickable: false },
  ...
  HOST_DEVICE_FROM_VM: [
    ...
    { accessor: 'capability',   header: '기능',                 clickable: false },
    { accessor: 'vendorName',   header: '벤더',                 clickable: false },
    { accessor: 'productName',  header: '제품',                 clickable: false },
  ...
  VIRTUAL_DISK: [
    { accessor: 'check',        header: "선택",                        clickable: false, width: DEFAULT_WIDTH_ICON_COLUMN },
    ...
    { accessor: 'interface',    header: '인터페이스',                  clickable: false },
    { accessor: 'readonly',     header: 'R/O',                         clickable: false, width: '5%' },
    { accessor: 'bootable',     header: 'bootable',                    clickable: false, width: '5%' },
    { accessor: 'sharable',     header: Localization.kr.IS_SHARABLE,   clickable: false, width: '5%' },
  ],
  // ---------------------------------------------------------------
