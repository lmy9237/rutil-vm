...
const ComputingTree = ({ selectedDiv, setSelectedDiv, getPaddingLeft }) => {
  ...
  return (
    <div id="virtual_machine_chart">
      ...
      <TreeMenuItem id="aside_popup_first"
        title="Rutil Manager"
        icon={<TreeMenuIconHardDrive />}
        isNextLevelVisible={isSecondVisible}
        setNextLevelVisible={setIsSecondVisible}
            ...
            <div key={dataCenter.id}>
              ...
              {isDataCenterOpen &&
                ...
                dataCenter.clusters.map((cluster) => {
                  ...
                  const hasHosts =
                    Array.isArray(cluster.hosts) && cluster.hosts.length > 0;
                  return (
                    <div key={cluster.id}>
                      <div
                      ...
                      >
                        {hasHosts && (
                          <FontAwesomeIcon
                            ...
                            icon={
                              isClusterOpen ? faChevronDown : faChevronRight
                            }
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        <>
                          ...
                          {Array.isArray(cluster.hosts) &&
                            cluster.hosts.map((host) => {
                              ...
                              const hasVMs =
                                Array.isArray(host.vms) && host.vms.length > 0;
                              return (
                                <div key={host.id}>
                                  <div
