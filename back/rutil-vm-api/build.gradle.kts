...
sourceSets {
    main {
        if (profile == "prd" || profile == "staging" || profile == "local20" || profile == "local70"  || profile == "local60" || profile == "local55" || profile == "local180") {
...
dependencies {
	...
	implementation(Dependencies.commonsVMWare)
	implementation(Dependencies.wsVMWare)
	implementation(Dependencies.bindVMWare)
