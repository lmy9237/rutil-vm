...
enum class ErrorPattern(
	...
	VM_STATUS_ERROR("VM-E005", Term.VM, FailureType.FORBIDDEN),
	...
	NETWORK_VO_INVALID("NETWORK-E003", Term.NETWORK, FailureType.BAD_REQUEST),
	NETWORK_OPERATIONAL_ERROR("NETWORK-E004", Term.NETWORK, FailureType.BAD_REQUEST),
	NETWORK_PROVIDER_ID_NOT_FOUND("NETWORKPROVIDER-E001", Term.NETWORK_PROVIDER, FailureType.ID_NOT_FOUND),
	NETWORK_PROVIDER_NOT_FOUND("NETWORKPROVIDER-E002", Term.NETWORK_PROVIDER, FailureType.NOT_FOUND),
	NETWORK_PROVIDER_VO_INVALID("NETWORKPROVIDER-E003", Term.NETWORK_PROVIDER, FailureType.BAD_REQUEST),
	...
	NIC_UNLINKED_REQUIRED("NIC-E004", Term.NIC, FailureType.PRECONDITION_FAILED, "실행 중인 가상머신에서 연결분리 불가능"),
...
fun ErrorPattern.toError(): Error {
	return when {
		...
		this in listOf(
			...
			ErrorPattern.NETWORK_PROVIDER_ID_NOT_FOUND,
		...
		this in listOf(
			...
			ErrorPattern.NETWORK_PROVIDER_NOT_FOUND,
