...
enum class AuditLogType(
	...
	private val severity: AuditLogSeverity? = null,
	val eventFloodRate: Int? = 0,
	...
	VDS_MAINTENANCE_FAILED(17, AuditLogSeverity.error,
		AuditLogTimeInterval.minute.value), // When VDS is transferred to maintenance mode
	VDS_ACTIVATE_FAILED(18, AuditLogSeverity.error,
		AuditLogTimeInterval.minute.value), // When VDS is reactivated
	VDS_RECOVER_FAILED(19, AuditLogSeverity.error,
		AuditLogTimeInterval.minute.value), // When VDS changes status down->up
	VDS_STATUS_CHANGE_FAILED_DUE_TO_STOP_SPM_FAILURE(27, AuditLogSeverity.warning,
		AuditLogTimeInterval.minute.value),
	VDS_PROVISION(28, AuditLogSeverity.warning, AuditLogTimeInterval.minute.value),
	VDS_SLOW_STORAGE_RESPONSE_TIME(123, AuditLogSeverity.warning,
		AuditLogTimeInterval.minute.value * 5), // ?
	...
	VDS_LOW_MEM(531, AuditLogSeverity.warning,
		AuditLogTimeInterval.minute.value * 30),
	...
	VDS_LOW_SWAP(536, AuditLogSeverity.warning,
		AuditLogTimeInterval.day.value),
	...
	VDS_INITIATED_RUN_VM_FAILED(507, AuditLogSeverity.error, AuditLogTimeInterval.second.value * 5),
	...
	VDS_INITIALIZING(514, AuditLogSeverity.warning,
		AuditLogTimeInterval.second.value * 30),
	...
	VDS_SET_NONOPERATIONAL(517, null, AuditLogTimeInterval.minute.value),
	...
	VDS_DOMAIN_DELAY_INTERVAL(524, AuditLogSeverity.warning,
		AuditLogTimeInterval.hour.value),
	VDS_LOW_DISK_SPACE(23, AuditLogSeverity.warning,
		AuditLogTimeInterval.hour.value),
	VDS_LOW_DISK_SPACE_ERROR(24, AuditLogSeverity.error,
		AuditLogTimeInterval.minute.value * 15),
	VDS_NO_SELINUX_ENFORCEMENT(25, AuditLogSeverity.warning, AuditLogTimeInterval.hour.value),
	...
	SYSTEM_VDS_RESTART(121, null, AuditLogTimeInterval.minute.value),
	SYSTEM_FAILED_VDS_RESTART(122, AuditLogSeverity.error,
		AuditLogTimeInterval.minute.value),
	// SSH restart
	SYSTEM_SSH_HOST_RESTART(197, null, AuditLogTimeInterval.minute.value),
	...
	VDS_TIME_DRIFT_ALERT(604, AuditLogSeverity.warning,
		AuditLogTimeInterval.minute.value * 60),
	...
	IRS_FAILURE(22, AuditLogSeverity.error,
		AuditLogTimeInterval.hour.value * 12),
	...
	// -- USER Log types --
	USER_VDC_LOGIN(30, null, AuditLogTimeInterval.second.value * 5), // user logged in to VDC
	USER_VDC_LOGIN_FAILED(114, AuditLogSeverity.error, AuditLogTimeInterval.second.value * 5), // user login failed
	...
	USER_LOGIN_ON_BEHALF(1401, null, AuditLogTimeInterval.second.value * 5), // user logged in for vmconsole
	...
	VM_FAILED_TO_PRESTART_IN_POOL(169, AuditLogSeverity.warning, AuditLogTimeInterval.hour.value),
	...
	SYSTEM_UPDATE_CLUSTER(835, null, AuditLogTimeInterval.minute.value),
	SYSTEM_UPDATE_CLUSTER_FAILED(836, null, AuditLogTimeInterval.minute.value),
	...
	HOST_CERTIFICATION_HAS_EXPIRED(877, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	HOST_CERTIFICATION_IS_ABOUT_TO_EXPIRE(845, AuditLogSeverity.warning, AuditLogTimeInterval.day.value),
	HOST_CERTIFICATION_IS_ABOUT_TO_EXPIRE_ALERT(879, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	ENGINE_CERTIFICATION_HAS_EXPIRED(846, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	ENGINE_CERTIFICATION_IS_ABOUT_TO_EXPIRE(847, AuditLogSeverity.warning, AuditLogTimeInterval.day.value),
	ENGINE_CERTIFICATION_IS_ABOUT_TO_EXPIRE_ALERT(878, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	ENGINE_CA_CERTIFICATION_HAS_EXPIRED(848, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	ENGINE_CA_CERTIFICATION_IS_ABOUT_TO_EXPIRE(849, AuditLogSeverity.warning, AuditLogTimeInterval.day.value),
	ENGINE_CA_CERTIFICATION_IS_ABOUT_TO_EXPIRE_ALERT(883, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	HOST_CERTIFICATION_IS_INVALID(876, AuditLogSeverity.error, AuditLogTimeInterval.day.value),
	HOST_CERTIFICATE_HAS_INVALID_SAN(889, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	OVIRT_PROVIDER_OVN_CERTIFICATE_HAS_EXPIRED(902, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	OVIRT_PROVIDER_OVN_CERTIFICATE_IS_ABOUT_TO_EXPIRE(903, AuditLogSeverity.warning, AuditLogTimeInterval.day.value),
	OVIRT_PROVIDER_OVN_CERTIFICATE_IS_ABOUT_TO_EXPIRE_ALERT(904, AuditLogSeverity.alert, AuditLogTimeInterval.day.value),
	...
	HOST_UPDATES_ARE_AVAILABLE_WITH_PACKAGES(843, AuditLogSeverity.normal, AuditLogTimeInterval.day.value * 1),
	HOST_UPDATES_ARE_AVAILABLE(844, AuditLogSeverity.normal, AuditLogTimeInterval.day.value * 1),
	...
	@Deprecated("")
	VDS_NETWORK_MTU_DIFFER_FROM_LOGICAL_NETWORK(1108, null, AuditLogTimeInterval.hour.value),
	...
	SYSTEM_CHANGE_STORAGE_POOL_STATUS_PROBLEMATIC_FROM_NON_OPERATIONAL(989, null, AuditLogTimeInterval.minute.value),
	...
	SYSTEM_CHANGE_STORAGE_POOL_STATUS_RESET_IRS(993, null, AuditLogTimeInterval.minute.value),
	...
	NUMBER_OF_LVS_ON_STORAGE_DOMAIN_EXCEEDED_THRESHOLD(1008, AuditLogSeverity.warning,
		AuditLogTimeInterval.hour.value * 3),
	...
	PROVIDER_SYNCHRONIZED_FAILED(216, AuditLogSeverity.error, AuditLogTimeInterval.day.value),
	PROVIDER_SYNCHRONIZED_PERFORMED(217),
	PROVIDER_SYNCHRONIZED_PERFORMED_FAILED(218, AuditLogSeverity.error, AuditLogTimeInterval.day.value),
	PROVIDER_SYNCHRONIZED_DISABLED(219, AuditLogSeverity.error),
	PROVIDER_AUTH_FAILED(220, AuditLogSeverity.error, AuditLogTimeInterval.day.value),
	...
	VDS_HOST_NOT_RESPONDING(9027, AuditLogSeverity.warning, AuditLogTimeInterval.minute.value * 3),
	...
	TASK_STOPPING_ASYNC_TASK(9500, null, AuditLogTimeInterval.minute.value),
	TASK_CLEARING_ASYNC_TASK(9501, null, AuditLogTimeInterval.minute.value),

	VDS_ACTIVATE_ASYNC(9502, null, AuditLogTimeInterval.hour.value * 3), // When VDS is reactivated by autorecovery
	VDS_ACTIVATE_MANUAL_HA_ASYNC(10455, AuditLogSeverity.warning,
		AuditLogTimeInterval.hour.value * 3), // When VDS is reactivated by autorecovery
	VDS_ACTIVATE_FAILED_ASYNC(9503, AuditLogSeverity.warning, AuditLogTimeInterval.hour.value * 3), // When VDS is
	// reactivated
	@Deprecated("")
	STORAGE_ACTIVATE_ASYNC(9504, null, AuditLogTimeInterval.hour.value * 3), // When VDS is reactivated by autorecovery

	USER_ACTIVATED_STORAGE_DOMAIN_ASYNC(9505, null, AuditLogTimeInterval.hour.value * 3),
	...
	RNG_SOURCES_INCOMPATIBLE_WITH_CLUSTER(9608, AuditLogSeverity.warning, AuditLogTimeInterval.minute.value),
	...
	CLUSTER_ALERT_HA_RESERVATION(10300, AuditLogSeverity.alert,
		AuditLogTimeInterval.minute.value * 10),
	...
	HOSTED_ENGINE_VM_IMPORT_FAILED(10457, AuditLogSeverity.error, AuditLogTimeInterval.hour.value * 2),
	HOSTED_ENGINE_SD_NOT_EXIT(10458, AuditLogSeverity.warning, AuditLogTimeInterval.hour.value * 2),
	HOSTED_ENGINE_SD_NOT_ACTIVE(10459, AuditLogSeverity.warning, AuditLogTimeInterval.hour.value * 2),
	HOSTED_ENGINE_DOMAIN_IMPORT_SUCCEEDED(10460, AuditLogSeverity.normal, AuditLogTimeInterval.hour.value),
	HOSTED_ENGINE_DOMAIN_IMPORT_FAILED(10461, AuditLogSeverity.error, AuditLogTimeInterval.hour.value),
	...
	DEPRECATED_API(13000, AuditLogSeverity.warning, AuditLogTimeInterval.day.value),
	...
	val defaultSeverity: AuditLogSeverity		get() = severity ?: AuditLogSeverity.normal
	val shouldBeLogged: Boolean					get() = this@AuditLogType != AuditLogType.unassigned

	override fun toString(): String = code
	val code: String
		get() = this@AuditLogType.name.uppercase()

	private val loc: Localization				get() = Localization.getInstance()
	val en: String								get() = loc.findLocalizedName4AuditLogType(this, "en")
	val kr: String								get() = loc.findLocalizedName4AuditLogType(this,"kr")

	companion object {
		private val valueMapping: MutableMap<Int, AuditLogType> = ConcurrentHashMap<Int, AuditLogType>()
		private val codeMapping: MutableMap<String, AuditLogType> = ConcurrentHashMap<String, AuditLogType>()
		init {
			AuditLogType.values().forEach {
				valueMapping[it.value] = it
				codeMapping[it.code] = it
				codeMapping[it.name] = it
			}
		}
		@JvmStatic fun forValue(value: Int?): AuditLogType = valueMapping[value] ?: unassigned
		@JvmStatic fun forCode(code: String?): AuditLogType = codeMapping[code ?: unassigned.code] ?: unassigned
		val REMOVE_IN_SCHEDULE = listOf<AuditLogType>(
			SCREENSHOT_VM_SUCCESS,
			USER_FAILED_TO_SCREENSHOT_VM,
		)
		val EXCLUDE_IN_QUERY = listOf<AuditLogType>(
			USER_VDC_LOGIN,
			USER_VDC_LOGOUT
		)
		val CODES_REMOVE_IN_SCHEDULE = REMOVE_IN_SCHEDULE.map { it.value }
		val CODES_EXCLUDE_IN_QUERY = EXCLUDE_IN_QUERY.map { it.value }
		val allAuditLogTypes: List<AuditLogSeverity> = AuditLogSeverity.values().toList()
	}
}
