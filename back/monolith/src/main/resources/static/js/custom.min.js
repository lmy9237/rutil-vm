...
if($("#canvasDoughnut").length){
	var f=document.getElementById("canvasDoughnut"),
		i={labels:["Dark Grey","Purple Color","Green Color","Blue Color"],datasets:[{data:[120,50],backgroundColor:["#9B59B6","#BDC3C7","#26B99A","#3498DB"],hoverBackgroundColor:["#B370CF","#CFD4D8","#36CAAB","#49A9EA"]}]};new Chart(f,{type:"doughnut",tooltipFillColor:"rgba(51, 51, 51, 0.55)",data:i})}
