...
MERGE INTO system_properties KEY (property) VALUES ('ip',                      'localhost');
MERGE INTO system_properties KEY (property) VALUES ('vnc_ip',                  'localhost');
...
MERGE INTO system_properties KEY (property) VALUES ('grafana_uri',             'https://localhost:3000/d-solo/8CzwBk1mk/vm-metrics');
MERGE INTO system_properties KEY (property) VALUES ('deepLearning_uri',        'https://localhost:25000/symphony/makeLearning');
