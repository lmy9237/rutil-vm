 ...
 * @property isPlugged [Boolean]
 * @property logicalName [String]
 * @property vmId [UUID]
 */
@Entity
@Immutable
@Table(name = "all_disks_for_vms")
class AllDisksForVmsEntity(
